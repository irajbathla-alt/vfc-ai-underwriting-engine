...
function vfcBankIsReturnedFinancingCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsReturnedFinancingCredit_(t);case'BMO':return vfcBmoIsReturnedFinancingCredit_(t);default:return false;}}
function vfcBankIsNonOperatingTransferCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsNonOperatingTransferCredit_(t);case'BMO':return vfcBmoIsNonOperatingTransferCredit_(t);default:return false;}}
function vfcBankPreservePrintedDuplicate_(bankId,t,occurrence,items){switch(String(bankId||'').toUpperCase()){case'BMO':return vfcBmoPreservePrintedDuplicate_(t,occurrence,items);default:return false;}}

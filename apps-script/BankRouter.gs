...
function vfcBankStrongEntityKey_(bankId,key,family){switch(String(bankId||'').toUpperCase()){case'RBC':return vfcRbcStrongEntityKey_(key);case'TD':return vfcTdStrongEntityKey_(key);case'BMO':return vfcBmoStrongEntityKey_(key);case'CIBC':return vfcCibcStrongEntityKey_(key);default:return false;}}
function vfcBankIsReturnedFinancingCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsReturnedFinancingCredit_(t);case'BMO':return vfcBmoIsReturnedFinancingCredit_(t);case'CIBC':return vfcCibcIsReturnedFinancingCredit_(t);default:return false;}}
function vfcBankIsNonOperatingTransferCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsNonOperatingTransferCredit_(t);case'BMO':return vfcBmoIsNonOperatingTransferCredit_(t);case'CIBC':return vfcCibcIsNonOperatingTransferCredit_(t);default:return false;}}
function vfcBankPreservePrintedDuplicate_(bankId,t,occurrence,items){switch(String(bankId||'').toUpperCase()){case'BMO':return vfcBmoPreservePrintedDuplicate_(t,occurrence,items);case'CIBC':return vfcCibcPreservePrintedDuplicate_(t,occurrence,items);default:return false;}}

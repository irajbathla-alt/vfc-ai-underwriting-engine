...
function vfcBankStrongEntityKey_(bankId,key,family){switch(String(bankId||'').toUpperCase()){case'RBC':return vfcRbcStrongEntityKey_(key);case'TD':return vfcTdStrongEntityKey_(key);default:return false;}}
function vfcBankIsReturnedFinancingCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsReturnedFinancingCredit_(t);default:return false;}}
function vfcBankIsNonOperatingTransferCredit_(bankId,t){switch(String(bankId||'').toUpperCase()){case'TD':return vfcTdIsNonOperatingTransferCredit_(t);default:return false;}}
